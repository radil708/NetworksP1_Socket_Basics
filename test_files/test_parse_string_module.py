import unittest
import parse_string_to_seg_module

class TestParseStringMod(unittest.TestCase):

    def test_int_only(self):
        expr0 = "7"
        dict_expr0 = parse_string_to_seg_module.\
            parse_string_to_dict(expr0)
    ...
    def test_simple_expr(self):
        expr1 = "( 1 + 2 )"
        dict_expr1 = parse_string_to_seg_module.\
            parse_string_to_dict(expr1)
    ...
    def test_complicated_easy1(self):
        expr2 = "( 5 * ( 2 // 3 ) )"
        dict_expr2 = parse_string_to_seg_module. \
            parse_string_to_dict(expr2)
    ...
    def test_complicated_easy2(self):
        expr3 = "( ( ( 1 + 2 ) - ( 3 - 4 ) ) // 6 )"
        dict_expr3 = parse_string_to_seg_module. \
            parse_string_to_dict(expr3)
    ...
    def test_complicated(self):
        ...
        dict_expr4 = parse_string_to_seg_module. \
            parse_string_to_dict(expr4)
    ...
    def testIsInt(self):
        x = "-2"
        self.assertTrue(parse_string_to_seg_module.isInt(x))

        y = "10"
        self.assertTrue(parse_string_to_seg_module.isInt(y))

        z = "( 2 + 4 )"
        self.assertFalse(parse_string_to_seg_module.isInt(z))

    def testLeftXOR(self):
        self.assertEqual(81925, parse_string_to_seg_module.left_and_XOR(10, 5))
        self.assertEqual(57386, parse_string_to_seg_module.left_and_XOR(7, 42))
